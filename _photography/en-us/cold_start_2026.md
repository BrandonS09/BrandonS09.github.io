...
Photography from the Cold Start 2026 motorsport event in San Francisco. This collection captures the intensity and excitement of motorsport racing.
  ...
  <div class="row">
    ...
    {% for img in images %}
      <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
        {% include figure.liquid loading="lazy" path="assets/img/cold_start_2026/{{ img }}" title="Cold Start 2026" class="img-fluid rounded z-depth-1" %}
      </div>
    {% endfor %}
  </div>
</div>
