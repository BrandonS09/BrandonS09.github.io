...
I am currently a research intern at Stanford University's [SHAPE Lab](https://shape.stanford.edu/), developing hardware for blind and low-vision users.

Previously, I designed and built the modular motorized test track at [Verdant Robotics](https://www.verdantrobotics.com/). I have also contributed to open source projects including [Mattermost](https://mattermost.com/) and [WPILib](https://wpilib.org/), and my research on barren plateau mitigation for quantum neural networks is published at peer-reviewed journals.
